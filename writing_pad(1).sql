...
CREATE TABLE `ad_banners` (
  ...
  `status` tinyint NOT NULL DEFAULT '1' COMMENT '-1:Deleted, 0:Inactive, 1:Active'
...
CREATE TABLE `authors` (
  ...
  `status` int NOT NULL DEFAULT '1' COMMENT '-1:Deleted, 0:Inactive, 1:Active'
...
CREATE TABLE `banners` (
  ...
  `redirect_url` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `created_by` int NOT NULL,
  `created_on` timestamp NULL DEFAULT NULL,
  `updated_by` int DEFAULT NULL,
  `updated_on` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `categories` (
  `pk_id` int NOT NULL,
  `name_kan` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
...
CREATE TABLE `debates` (
  `pk_id` int NOT NULL,
  `topic` varchar(300) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `description` text CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `language` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT 'KAN / ENG',
  `created_by` int NOT NULL,
  `created_on` timestamp NULL DEFAULT NULL,
  `updated_by` int DEFAULT NULL,
  `updated_on` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `posts` (
  `pk_id` int NOT NULL,
  `mainpost_id` int NOT NULL,
  `user_id` int NOT NULL,
  `section_id` int NOT NULL,
  `category_id` int NOT NULL,
  `subcategory_id` int NOT NULL,
  `has_episodes` tinyint NOT NULL DEFAULT '0',
  ...
  `cover_image` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
CREATE TABLE `products` (
  ...
  `hsn_code` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
CREATE TABLE `prod_category` (
  ...
  `updated_on` datetime NOT NULL,
  `updated_by` int NOT NULL,
  `page_url` varchar(120) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `reg_users` (
  ...
  `profile_path` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `phone_no` varchar(20) NOT NULL,
  `password` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `is_verified` int NOT NULL DEFAULT '0',
  `verified_on` timestamp NULL DEFAULT NULL,
  `last_login` timestamp NULL DEFAULT NULL,
  `login_remarks` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `created_by` int NOT NULL,
  `created_on` timestamp NULL DEFAULT NULL,
  `updated_by` int NOT NULL,
  `updated_on` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `sections` (
  `pk_id` int NOT NULL,
  `name_kan` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `name_eng` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `order_no` int NOT NULL,
...
(1, 'Admin', 'adminlandview@landviewreality.com', 'superadmin', '$2y$10$oOQVfnCjBpA0Qwth7ZZSaenD6DrZJ06wIyoI6K13.oSb0ojFCQagK', 0, NULL, 0, NULL, 1),
...
--
ALTER TABLE `ad_banners`
  MODIFY `pk_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `authors`
--
ALTER TABLE `authors`
  MODIFY `pk_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `banners`
--
ALTER TABLE `banners`
  MODIFY `pk_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `categories`
--
ALTER TABLE `categories`
  MODIFY `pk_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `collection_posts`
--
ALTER TABLE `collection_posts`
  MODIFY `pk_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `debates`
--
ALTER TABLE `debates`
  MODIFY `pk_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `debate_comments`
--
ALTER TABLE `debate_comments`
  MODIFY `pk_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
...
--
ALTER TABLE `my_collections`
  MODIFY `pk_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `posts`
--
ALTER TABLE `posts`
  MODIFY `pk_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
...
--
ALTER TABLE `post_viewcounts`
  MODIFY `pk_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `tags`
  MODIFY `pk_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT for table `users`
--
ALTER TABLE `users`
  MODIFY `pk_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
